...
const Marketplace: React.FC = () => {
  ...
  }, [agents, searchQuery, selectedCategory, priceRange, minRating, sortBy]);
    ...
    <div className="min-h-screen bg-gray-900 text-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
              ...
              >
                <div className="aspect-w-16 aspect-h-9 bg-gray-800 relative">
                  ...
                  <div className="absolute bottom-0 left-0 p-4">
                    ...
                    <p className="text-sm text-gray-300">{category.count} agents</p>
                  </div>
                </div>
              </motion.div>
            ))}
        ...
        <div className="mb-8 flex flex-col md:flex-row justify-between items-start md:items-center space-y-4 md:space-y-0">
          <button 
            className="flex items-center space-x-2 bg-gray-800 hover:bg-gray-700 px-4 py-2 rounded-lg text-gray-300 transition"
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  />
                  <span className="text-gray-300">Max: ${priceRange[1].toFixed(2)}</span>
                </div>
              </div>
